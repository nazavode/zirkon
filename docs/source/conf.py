...
# -*- coding: utf-8 -*-
#
# zirkon documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'zirkon.tex', 'zirkon Documentation',
...
man_pages = [
    (master_doc, 'zirkon', 'zirkon Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'zirkon', 'zirkon Documentation',
   author, 'zirkon', 'One line description of project.',
   'Miscellaneous'),
]
